...
this._buildButton(n,d,n.split!==q||n.config!==q&&n.config.split!==q,k);if(g){e!==q&&null!==e?(a.splice(e,0,g),e++):a.push(g);if(g.conf.buttons||g.conf.split){g.collection=f("<"+(b?this.c.dom.splitCollection.tag:this.c.dom.collection.tag)+"/>");g.conf._collection=g.collection;if(g.conf.split)for(var t=0;t<g.conf.split.length;t++)"object"===typeof g.conf.split[t]&&(g.conf.split[t].parent=h,g.conf.split[t].collectionLayout===q&&(g.conf.split[t].collectionLayout=g.conf.collectionLayout),g.conf.split[t].dropup===
...
splitAlignClass:this.c.dom.splitDropdown.splitAlignClass});this._addKey(B);var G=function(w,A,E,F){y.split.action.call(A.button(f("div.dt-btn-split-wrapper")[0]),w,A,E,F);f(A.table().node()).triggerHandler("buttons-action.dt",[A.button(E),A,E,F]);E.attr("aria-expanded",!0)},D=f('<button class="'+this.c.dom.splitDropdown.className+' dt-button"><span class="dt-btn-split-drop-arrow">'+this.c.dom.splitDropdown.text+"</span></button>").on("click.dtb",function(w){w.preventDefault();w.stopPropagation();
D.hasClass(k.disabled)||G(w,p,D,B);z&&D.trigger("blur")}).on("keypress.dtb",function(w){13===w.keyCode&&(w.preventDefault(),D.hasClass(k.disabled)||G(w,p,D,B))});0===a.split.length&&D.addClass("dtb-hide-drop");n.append(D).attr(B.attr)}return{conf:a,node:c?n.get(0):g.get(0),inserter:c?n:e,buttons:[],inCollection:b,isSplit:c,inSplit:d,collection:null}},_nodeToButton:function(a,b){b||(b=this.s.buttons);for(var c=0,d=b.length;c<d;c++){if(b[c].node===a)return b[c];if(b[c].buttons.length){var k=this._nodeToButton(a,
...
!b.ctrlKey||h.key.metaKey&&!b.metaKey||(b._buttonsHandled=!0,f(l).click()));d[k].buttons.length&&c(d[k].buttons)}};c(this.s.buttons)}},_removeKey:function(a){if(a.key){var b=f.isPlainObject(a.key)?a.key.key:a.key;a=this.s.listenKeys.split("");b=f.inArray(b,a);a.splice(b,1);this.s.listenKeys=a.join("")}},_resolveExtends:function(a){var b=this,c=this.s.dt,d,k=function(m){for(var p=0;!f.isPlainObject(m)&&!Array.isArray(m);){if(m===q)return;if("function"===typeof m){if(m=m.call(b,c,a),!m)return!1}else if("string"===
typeof m){if(!y[m])return{html:m};m=y[m]}p++;if(30<p)throw"Buttons: Too many iterations";}return Array.isArray(m)?m:f.extend({},m)};for(a=k(a);a&&a.extend;){if(!y[a.extend])throw"Cannot extend unknown button type: "+a.extend;var e=k(y[a.extend]);if(Array.isArray(e))return e;if(!e)return!1;var h=e.className;a.config!==q&&e.config!==q&&(a.config=f.extend({},e.config,a.config));a=f.extend({},e,a);h&&a.className!==h&&(a.className=h+" "+a.className);var l=a.postfixButtons;if(l){a.buttons||(a.buttons=[]);
...
rightAlignClassName:"dt-button-right",splitRightAlignClassName:"dt-button-split-right",splitLeftAlignClassName:"dt-button-split-left",tag:d.dom.collection.tag},c),h=b.node(),l=function(){k=!0;J(f(".dt-button-collection"),e.fade,function(){f(this).detach()});f(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes()).attr("aria-expanded","false");f("div.dt-button-background").off("click.dtb-collection");v.background(!1,e.backgroundClassName,e.fade,h);f("body").off(".dtb-collection");b.off("buttons-action.b-internal");
b.off("destroy")};if(!1===a)l();else{c=f(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes());c.length&&(h.closest("div.dt-button-collection").length&&(h=c.eq(0)),l());c=f("<div/>").addClass("dt-button-collection").addClass(e.collectionLayout).addClass(e.splitAlignClass).css("display","none");a=f(a).addClass(e.contentClassName).attr("role","menu").appendTo(c);h.attr("aria-expanded","true");h.parents("body")[0]!==x.body&&(h=x.body.lastChild);e.popoverTitle?c.prepend('<div class="dt-button-collection-title">'+
e.popoverTitle+"</div>"):e.collectionTitle&&c.prepend('<div class="dt-button-collection-title">'+e.collectionTitle+"</div>");console.log(e.closeButton);e.closeButton&&c.prepend('<div class="dtb-popover-close">x</div>').addClass("dtb-collection-closeable");I(c.insertAfter(h),e.fade);var m=f(b.table().container());d=c.css("position");"dt-container"===e.align&&(h=h.parent(),c.css("width",m.width()));if("absolute"===d){var p=h.position();d=f(b.node()).position();c.css({top:f(f(b[0].node).parent()[0]).hasClass("dt-buttons")?
d.top+h.outerHeight():p.top+h.outerHeight(),left:p.left});p=c.outerHeight();var r=m.offset().top+m.height();r=d.top+h.outerHeight()+p-r;var n=d.top-p,g=m.offset().top;d=d.top-p-5;(r>g-n||e.dropup)&&-d<g&&c.css("top",d);d=m.offset().left;m=m.width();m=d+m;p=c.offset().left;r=c.outerWidth();0===r&&0<c.children().length&&(r=f(c.children()[0]).outerWidth());r=p+r;var t=h.offset().left;g=h.outerWidth();n=t+g;if(c.hasClass(e.rightAlignClassName)||c.hasClass(e.leftAlignClassName)||c.hasClass(e.splitAlignClass)||
"dt-container"===e.align){var z=n;h.hasClass("dt-btn-split-wrapper")&&0<h.children("button.dt-btn-split-drop").length&&(t=h.children("button.dt-btn-split-drop").offset().left,g=h.children("button.dt-btn-split-drop").outerWidth(),z=t+g);g=0;if(c.hasClass(e.rightAlignClassName))g=n-r,d>p+g&&(d-=p+g,m-=r+g,g=d>m?g+m:g+d);else if(c.hasClass(e.splitRightAlignClassName))g=z-r,d>p+g&&(d-=p+g,m-=r+g,g=d>m?g+m:g+d);else if(c.hasClass(e.splitLeftAlignClassName)){if(g=t-p,m<r+g||d>p+g)d-=p+g,m-=r+g,g=d>m?g+
m:g+d}else g=d-p,m<r+g&&(d-=p+g,m-=r+g,g=d>m?g+m:g+d)}else d=h.offset().top,g=0,g="button-right"===e.align?n-r:t-p;c.css("left",c.position().left+g)}else d=c.height()/2,d>f(C).height()/2&&(d=f(C).height()/2),c.css("marginTop",-1*d);e.background&&v.background(!0,e.backgroundClassName,e.fade,e.backgroundHost||h);f("div.dt-button-background").on("click.dtb-collection",function(){});e.autoClose&&setTimeout(function(){b.on("buttons-action.b-internal",function(B,G,D,w){w[0]!==h[0]&&l()})},0);f(c).trigger("buttons-popover.dt");
b.on("destroy",l);setTimeout(function(){k=!1;f("body").on("click.dtb-collection",function(B){if(!k){var G=f.fn.addBack?"addBack":"andSelf",D=f(B.target).parent()[0];(!f(B.target).parents()[G]().filter(a).length&&!f(D).hasClass("dt-buttons")||f(B.target).hasClass("dt-button-background"))&&l()}}).on("keyup.dtb-collection",function(B){27===B.keyCode&&l()})},0)}}});v.background=function(a,b,c,d){c===q&&(c=400);d||(d=x.body);a?I(f("<div/>").addClass(b).css("display","none").insertAfter(d),c):J(f("div."+
b),c,function(){f(this).removeClass(b).remove()})};v.instanceSelector=function(a,b){if(a===q||null===a)return f.map(b,function(e){return e.inst});var c=[],d=f.map(b,function(e){return e.name}),k=function(e){if(Array.isArray(e))for(var h=0,l=e.length;h<l;h++)k(e[h]);else"string"===typeof e?-1!==e.indexOf(",")?k(e.split(",")):(e=f.inArray(e.trim(),d),-1!==e&&c.push(b[e].inst)):"number"===typeof e?c.push(b[e].inst):"object"===typeof e&&c.push(e)};k(a);return c};v.buttonSelector=function(a,b){for(var c=
[],d=function(l,m,p){for(var r,n,g=0,t=m.length;g<t;g++)if(r=m[g])n=p!==q?p+g:g+"",l.push({node:r.node,name:r.conf.name,idx:n}),r.buttons&&d(l,r.buttons,n+"-")},k=function(l,m){var p,r=[];d(r,m.s.buttons);var n=f.map(r,function(g){return g.node});if(Array.isArray(l)||l instanceof f)for(n=0,p=l.length;n<p;n++)k(l[n],m);else if(null===l||l===q||"*"===l)for(n=0,p=r.length;n<p;n++)c.push({inst:m,node:r[n].node});else if("number"===typeof l)m.s.buttons[l]&&c.push({inst:m,node:m.s.buttons[l].node});else if("string"===
typeof l)if(-1!==l.indexOf(","))for(r=l.split(","),n=0,p=r.length;n<p;n++)k(r[n].trim(),m);else if(l.match(/^\d+(\-\d+)*$/))n=f.map(r,function(g){return g.idx}),c.push({inst:m,node:r[f.inArray(l,n)].node});else if(-1!==l.indexOf(":name"))for(l=l.replace(":name",""),n=0,p=r.length;n<p;n++)r[n].name===l&&c.push({inst:m,node:r[n].node});else f(n).filter(l).each(function(){c.push({inst:m,node:this})});else"object"===typeof l&&l.nodeName&&(r=f.inArray(l,n),-1!==r&&c.push({inst:m,node:n[r]}))},e=0,h=a.length;e<
h;e++)k(b,a[e]);return c};v.stripData=function(a,b){if("string"!==typeof a)return a;a=a.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"");a=a.replace(/<!\-\-.*?\-\->/g,"");if(!b||b.stripHtml)a=a.replace(/<[^>]*>/g,"");if(!b||b.trim)a=a.replace(/^\s+|\s+$/g,"");if(!b||b.stripNewlines)a=a.replace(/\n/g," ");if(!b||b.decodeEntities)M.innerHTML=a,a=M.value;return a};v.defaults={buttons:["copy","excel","csv","pdf","print"],name:"main",tabIndex:0,dom:{container:{tag:"div",className:"dt-buttons"},
collection:{tag:"div",className:""},button:{tag:"button",className:"dt-button",active:"active",disabled:"disabled",spacerClass:""},buttonLiner:{tag:"span",className:""},split:{tag:"div",className:"dt-button-split"},splitWrapper:{tag:"div",className:"dt-btn-split-wrapper"},splitDropdown:{tag:"button",text:"&#x25BC;",className:"dt-btn-split-drop",align:"split-right",splitAlignClass:"dt-button-split-left"},splitDropdownButton:{tag:"button",className:"dt-btn-split-drop-button dt-button"},splitCollection:{tag:"div",
className:"dt-button-split-collection"}}};v.version="2.1.1";f.extend(y,{collection:{text:function(a){return a.i18n("buttons.collection","Collection")},className:"buttons-collection",closeButton:!1,init:function(a,b,c){b.attr("aria-expanded",!1)},action:function(a,b,c,d){d._collection.parents("body").length?this.popover(!1,d):this.popover(d._collection,d)},attr:{"aria-haspopup":!0}},split:{text:function(a){return a.i18n("buttons.split","Split")},className:"buttons-split",closeButton:!1,init:function(a,
b,c){return b.attr("aria-expanded",!1)},action:function(a,b,c,d){this.popover(d._collection,d)},attr:{"aria-haspopup":!0}},copy:function(a,b){if(y.copyHtml5)return"copyHtml5"},csv:function(a,b){if(y.csvHtml5&&y.csvHtml5.available(a,b))return"csvHtml5"},excel:function(a,b){if(y.excelHtml5&&y.excelHtml5.available(a,b))return"excelHtml5"},pdf:function(a,b){if(y.pdfHtml5&&y.pdfHtml5.available(a,b))return"pdfHtml5"},pageLength:function(a){a=a.settings()[0].aLengthMenu;var b=[],c=[];if(Array.isArray(a[0]))b=
a[0],c=a[1];else for(var d=0;d<a.length;d++){var k=a[d];f.isPlainObject(k)?(b.push(k.value),c.push(k.label)):(b.push(k),c.push(k))}return{extend:"collection",text:function(e){return e.i18n("buttons.pageLength",{"-1":"Show all rows",_:"Show %d rows"},e.page.len())},className:"buttons-page-length",autoClose:!0,buttons:f.map(b,function(e,h){return{text:c[h],className:"button-page-length",action:function(l,m){m.page.len(e).draw()},init:function(l,m,p){var r=this;m=function(){r.active(l.page.len()===e)};
...
c)}},customizeData:null},b);b=a.columns(c.columns).indexes().map(function(t){var z=a.column(t).header();return c.format.header(z.innerHTML,t,z)}).toArray();var d=a.table().footer()?a.columns(c.columns).indexes().map(function(t){var z=a.column(t).footer();return c.format.footer(z?z.innerHTML:"",t,z)}).toArray():null,k=f.extend({},c.modifier);a.select&&"function"===typeof a.select.info&&k.selected===q&&a.rows(c.rows,f.extend({selected:!0},k)).any()&&f.extend(k,{selected:!0});k=a.rows(c.rows,k).indexes().toArray();
var e=a.cells(k,c.columns);k=e.render(c.orthogonal).toArray();e=e.nodes().toArray();for(var h=b.length,l=[],m=0,p=0,r=0<h?k.length/h:0;p<r;p++){for(var n=[h],g=0;g<h;g++)n[g]=c.format.body(k[m],p,g,e[m]),m++;l[p]=n}b={header:b,footer:d,body:l};c.customizeData&&c.customizeData(b);return b};f.fn.dataTable.Buttons=v;f.fn.DataTable.Buttons=v;f(x).on("init.dt plugin-init.dt",function(a,b){"dt"===a.namespace&&(a=b.oInit.buttons||u.defaults.buttons)&&!b._buttons&&(new v(b,a)).container()});u.ext.feature.push({fnInit:L,

...
disabled:"disabled"},buttonLiner:{tag:"span",className:""}}};l.version="1.5.2";e.extend(k,{collection:{text:function(a){return a.i18n("buttons.collection","Collection")},className:"buttons-collection",action:function(a,b,c,d){var g=e(c).parents("div.dt-button-collection"),a=c.position(),h=e(b.table().container()),f=!1,i=c;g.length&&(f=e(".dt-button-collection").position(),i=g,e("body").trigger("click.dtb-collection"));i.parents("body")[0]!==n.body&&(i=n.body.lastChild);d._collection.find(".dt-button-collection-title").remove();

...
name:this.c.name});for(var k=0,e=d.length;k<e;k++)this.add(d[k]);b.on("destroy",function(h,l){l===c&&a.destroy()});f("body").on("keyup."+this.s.namespace,function(h){if(!x.activeElement||x.activeElement===x.body){var l=String.fromCharCode(h.keyCode).toLowerCase();-1!==a.s.listenKeys.toLowerCase().indexOf(l)&&a._keypress(l,h)}})},_addKey:function(a){a.key&&(this.s.listenKeys+=f.isPlainObject(a.key)?a.key.key:a.key)},_draw:function(a,b){a||(a=this.dom.container,b=this.s.buttons);a.children().detach();
...
function(w){return"function"===typeof w?w(p,g,a):w};if(a.spacer){var n=f("<span></span>").addClass("dt-button-spacer "+a.style).text(r(a.text));return{conf:a,node:n,inserter:n,buttons:[],inCollection:b,isSplit:c,inSplit:d,collection:null}}!c&&d&&l?k=m:!c&&b&&h.button&&(k=h.button);!c&&d&&l.buttonLiner?e=l.buttonLiner:!c&&b&&h.buttonLiner&&(e=h.buttonLiner);if(a.available&&!a.available(p,a)&&!a.hasOwnProperty("html"))return!1;if(a.hasOwnProperty("html"))var g=f(a.html);else{var t=function(w,B,E,F){F.action.call(B.button(E),
w,B,E,F);f(B.table().node()).triggerHandler("buttons-action.dt",[B.button(E),B,E,F])};h=a.tag||k.tag;var A=a.clickBlurs===q?!0:a.clickBlurs;g=f("<"+h+"/>").addClass(k.className).addClass(d?this.c.dom.splitDropdownButton.className:"").attr("tabindex",this.s.dt.settings()[0].iTabIndex).attr("aria-controls",this.s.dt.table().node().id).on("click.dtb",function(w){w.preventDefault();!g.hasClass(k.disabled)&&a.action&&t(w,p,g,a);A&&g.trigger("blur")}).on("keypress.dtb",function(w){13===w.keyCode&&(w.preventDefault(),
!g.hasClass(k.disabled)&&a.action&&t(w,p,g,a))});"a"===h.toLowerCase()&&g.attr("href","#");"button"===h.toLowerCase()&&g.attr("type","button");e.tag?(h=f("<"+e.tag+"/>").html(r(a.text)).addClass(e.className),"a"===e.tag.toLowerCase()&&h.attr("href","#"),g.append(h)):g.html(r(a.text));!1===a.enabled&&g.addClass(k.disabled);a.className&&g.addClass(a.className);a.titleAttr&&g.attr("title",r(a.titleAttr));a.attr&&g.attr(a.attr);a.namespace||(a.namespace=".dt-button-"+P++);a.config!==q&&a.config.split&&
(a.split=a.config.split)}e=(e=this.c.dom.buttonContainer)&&e.tag?f("<"+e.tag+"/>").addClass(e.className).append(g):g;this._addKey(a);this.c.buttonCreated&&(e=this.c.buttonCreated(a,e));if(c){n=f("<div/>").addClass(this.c.dom.splitWrapper.className);n.append(g);var z=f.extend(a,{text:this.c.dom.splitDropdown.text,className:this.c.dom.splitDropdown.className,attr:{"aria-haspopup":!0,"aria-expanded":!1},align:this.c.dom.splitDropdown.align,splitAlignClass:this.c.dom.splitDropdown.splitAlignClass});this._addKey(z);
var G=function(w,B,E,F){y.split.action.call(B.button(f("div.dt-btn-split-wrapper")[0]),w,B,E,F);f(B.table().node()).triggerHandler("buttons-action.dt",[B.button(E),B,E,F]);E.attr("aria-expanded",!0)},D=f('<button class="'+this.c.dom.splitDropdown.className+' dt-button"><span class="dt-btn-split-drop-arrow">'+this.c.dom.splitDropdown.text+"</span></button>").on("click.dtb",function(w){w.preventDefault();w.stopPropagation();!D.hasClass(k.disabled)&&z.action&&G(w,p,D,z);A&&D.trigger("blur")}).on("keypress.dtb",
function(w){13===w.keyCode&&(w.preventDefault(),!D.hasClass(k.disabled)&&z.action&&G(w,p,D,z))});0===a.split.length&&D.addClass("dtb-hide-drop");n.append(D).attr(z.attr)}return{conf:a,node:c?n.get(0):g.get(0),inserter:c?n:e,buttons:[],inCollection:b,isSplit:c,inSplit:d,collection:null}},_nodeToButton:function(a,b){b||(b=this.s.buttons);for(var c=0,d=b.length;c<d;c++){if(b[c].node===a)return b[c];if(b[c].buttons.length){var k=this._nodeToButton(a,b[c].buttons);if(k)return k}}},_nodeToHost:function(a,
b){b||(b=this.s.buttons);for(var c=0,d=b.length;c<d;c++){if(b[c].node===a)return b;if(b[c].buttons.length){var k=this._nodeToHost(a,b[c].buttons);if(k)return k}}},_keypress:function(a,b){if(!b._buttonsHandled){var c=function(d){for(var k=0,e=d.length;k<e;k++){var h=d[k].conf,l=d[k].node;h.key&&(h.key===a?(b._buttonsHandled=!0,f(l).click()):!f.isPlainObject(h.key)||h.key.key!==a||h.key.shiftKey&&!b.shiftKey||h.key.altKey&&!b.altKey||h.key.ctrlKey&&!b.ctrlKey||h.key.metaKey&&!b.metaKey||(b._buttonsHandled=
!0,f(l).click()));d[k].buttons.length&&c(d[k].buttons)}};c(this.s.buttons)}},_removeKey:function(a){if(a.key){var b=f.isPlainObject(a.key)?a.key.key:a.key;a=this.s.listenKeys.split("");b=f.inArray(b,a);a.splice(b,1);this.s.listenKeys=a.join("")}},_resolveExtends:function(a){var b=this,c=this.s.dt,d,k=function(m){for(var p=0;!f.isPlainObject(m)&&!Array.isArray(m);){if(m===q)return;if("function"===typeof m){if(m=m.call(b,c,a),!m)return!1}else if("string"===typeof m){if(!y[m])return{html:m};m=y[m]}p++;
...
c.css("top",d);d=m.offset().left;m=m.width();m=d+m;p=c.offset().left;r=c.outerWidth();0===r&&0<c.children().length&&(r=f(c.children()[0]).outerWidth());r=p+r;var t=h.offset().left;g=h.outerWidth();n=t+g;if(c.hasClass(e.rightAlignClassName)||c.hasClass(e.leftAlignClassName)||c.hasClass(e.splitAlignClass)||"dt-container"===e.align){var A=n;h.hasClass("dt-btn-split-wrapper")&&0<h.children("button.dt-btn-split-drop").length&&(t=h.children("button.dt-btn-split-drop").offset().left,g=h.children("button.dt-btn-split-drop").outerWidth(),
A=t+g);g=0;if(c.hasClass(e.rightAlignClassName))g=n-r,d>p+g&&(d-=p+g,m-=r+g,g=d>m?g+m:g+d);else if(c.hasClass(e.splitRightAlignClassName))g=A-r,d>p+g&&(d-=p+g,m-=r+g,g=d>m?g+m:g+d);else if(c.hasClass(e.splitLeftAlignClassName)){if(g=t-p,m<r+g||d>p+g)d-=p+g,m-=r+g,g=d>m?g+m:g+d}else g=d-p,m<r+g&&(d-=p+g,m-=r+g,g=d>m?g+m:g+d)}else d=h.offset().top,g=0,g="button-right"===e.align?n-r:t-p;c.css("left",c.position().left+g)}else d=c.height()/2,d>f(C).height()/2&&(d=f(C).height()/2),c.css("marginTop",-1*
d);e.background&&v.background(!0,e.backgroundClassName,e.fade,h);f("div.dt-button-background").on("click.dtb-collection",function(){});e.autoClose&&setTimeout(function(){b.on("buttons-action.b-internal",function(z,G,D,w){w[0]!==h[0]&&l()})},0);f(c).trigger("buttons-popover.dt");b.on("destroy",l);setTimeout(function(){k=!1;f("body").on("click.dtb-collection",function(z){if(!k){var G=f.fn.addBack?"addBack":"andSelf",D=f(z.target).parent()[0];(!f(z.target).parents()[G]().filter(a).length&&!f(D).hasClass("dt-buttons")||
f(z.target).hasClass("dt-button-background"))&&l()}}).on("keyup.dtb-collection",function(z){27===z.keyCode&&l()})},0)}}});v.background=function(a,b,c,d){c===q&&(c=400);d||(d=x.body);a?I(f("<div/>").addClass(b).css("display","none").insertAfter(d),c):J(f("div."+b),c,function(){f(this).removeClass(b).remove()})};v.instanceSelector=function(a,b){if(a===q||null===a)return f.map(b,function(e){return e.inst});var c=[],d=f.map(b,function(e){return e.name}),k=function(e){if(Array.isArray(e))for(var h=0,l=
...
this.button(this[0].node),b)})});u.Api.register("buttons().containers()",function(){var a=f(),b=this._groupSelector;this.iterator(!0,"table",function(c){if(c._buttons){c=v.instanceSelector(b,c._buttons);for(var d=0,k=c.length;d<k;d++)a=a.add(c[d].container())}});return a});u.Api.register("buttons().container()",function(){return this.containers().eq(0)});u.Api.register("button().add()",function(a,b,c){var d=this.context;d.length&&(d=v.instanceSelector(this._groupSelector,d[0]._buttons),d.length&&
d[0].add(b,a,c));return this.button(this._groupSelector,a)});u.Api.register("buttons().destroy()",function(){this.pluck("inst").unique().each(function(a){a.destroy()});return this});u.Api.registerPlural("buttons().remove()","buttons().remove()",function(){this.each(function(a){a.inst.remove(a.node)});return this});var H;u.Api.register("buttons.info()",function(a,b,c){var d=this;if(!1===a)return this.off("destroy.btn-info"),J(f("#datatables_buttons_info"),400,function(){f(this).remove()}),clearTimeout(H),
H=null,this;H&&clearTimeout(H);f("#datatables_buttons_info").length&&f("#datatables_buttons_info").remove();a=a?"<h2>"+a+"</h2>":"";I(f('<div id="datatables_buttons_info" class="dt-button-info"/>').html(a).append(f("<div/>")["string"===typeof b?"html":"append"](b)).css("display","none").appendTo("body"));c!==q&&0!==c&&(H=setTimeout(function(){d.buttons.info(!1)},c));this.on("destroy.btn-info",function(){d.buttons.info(!1)});return this});u.Api.register("buttons.exportData()",function(a){if(this.context.length)return Q(new u.Api(this.context[0]),
a)});u.Api.register("buttons.exportInfo()",function(a){a||(a={});var b=a;var c="*"===b.filename&&"*"!==b.title&&b.title!==q&&null!==b.title&&""!==b.title?b.title:b.filename;"function"===typeof c&&(c=c());c===q||null===c?c=null:(-1!==c.indexOf("*")&&(c=c.replace("*",f("head > title").text()).trim()),c=c.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g,""),(b=K(b.extension))||(b=""),c+=b);b=K(a.title);b=null===b?null:-1!==b.indexOf("*")?b.replace("*",f("head > title").text()||"Exported data"):b;return{filename:c,
...
stripNewlines:!0,decodeEntities:!0,trim:!0,format:{header:function(t){return v.stripData(t,c)},footer:function(t){return v.stripData(t,c)},body:function(t){return v.stripData(t,c)}},customizeData:null},b);b=a.columns(c.columns).indexes().map(function(t){var A=a.column(t).header();return c.format.header(A.innerHTML,t,A)}).toArray();var d=a.table().footer()?a.columns(c.columns).indexes().map(function(t){var A=a.column(t).footer();return c.format.footer(A?A.innerHTML:"",t,A)}).toArray():null,k=f.extend({},
c.modifier);a.select&&"function"===typeof a.select.info&&k.selected===q&&a.rows(c.rows,f.extend({selected:!0},k)).any()&&f.extend(k,{selected:!0});k=a.rows(c.rows,k).indexes().toArray();var e=a.cells(k,c.columns);k=e.render(c.orthogonal).toArray();e=e.nodes().toArray();for(var h=b.length,l=[],m=0,p=0,r=0<h?k.length/h:0;p<r;p++){for(var n=[h],g=0;g<h;g++)n[g]=c.format.body(k[m],p,g,e[m]),m++;l[p]=n}b={header:b,footer:d,body:l};c.customizeData&&c.customizeData(b);return b};f.fn.dataTable.Buttons=v;
f.fn.DataTable.Buttons=v;f(x).on("init.dt plugin-init.dt",function(a,b){"dt"===a.namespace&&(a=b.oInit.buttons||u.defaults.buttons)&&!b._buttons&&(new v(b,a)).container()});u.ext.feature.push({fnInit:L,cFeature:"B"});u.ext.features&&u.ext.features.register("buttons",L);return v});

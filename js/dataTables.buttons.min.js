...
left:a.left}),f=g.offset().top+g.height(),f=a.top+c.outerHeight()+e._collection.outerHeight()-f,h=a.top-e._collection.outerHeight(),h=g.offset().top-h,f>h&&e._collection.css("top",a.top-e._collection.outerHeight()-5),f=a.left+e._collection.outerWidth(),g=g.offset().left+g.width(),f>g&&e._collection.css("left",a.left-(f-g)),c=c.offset().left+e._collection.outerWidth(),f>d(n).width()&&e._collection.css("left",a.left-(c-d(n).width()))):(c=e._collection.height()/2,c>d(n).height()/2&&(c=d(n).height()/

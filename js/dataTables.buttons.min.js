...
f("body").off(".dtb-collection");b.off("buttons-action.b-internal");b.off("destroy")};if(!1===a)m();else{c=f(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes());c.length&&(g.closest("div.dt-button-collection").length&&(g=c.eq(0)),m());c=f(".dt-button",a).length;d="";3===c?d="dtb-b3":2===c?d="dtb-b2":1===c&&(d="dtb-b1");var k=f("<div/>").addClass("dt-button-collection").addClass(e.collectionLayout).addClass(e.splitAlignClass).addClass(d).css("display","none");a=f(a).addClass(e.contentClassName).attr("role",
"menu").appendTo(k);g.attr("aria-expanded","true");g.parents("body")[0]!==z.body&&(g=z.body.lastChild);e.popoverTitle?k.prepend('<div class="dt-button-collection-title">'+e.popoverTitle+"</div>"):e.collectionTitle&&k.prepend('<div class="dt-button-collection-title">'+e.collectionTitle+"</div>");e.closeButton&&k.prepend('<div class="dtb-popover-close">x</div>').addClass("dtb-collection-closeable");I(k.insertAfter(g),e.fade);d=f(b.table().container());var t=k.css("position");"dt-container"===e.align&&
(g=g.parent(),k.css("width",d.width()));if("absolute"===t){var r=g.position();c=f(b.node()).position();k.css({top:f(f(b[0].node).parent()[0]).hasClass("dt-buttons")?c.top+g.outerHeight():r.top+g.outerHeight(),left:r.left});r=k.outerHeight();var n=d.offset().top+d.height();n=c.top+g.outerHeight()+r-n;var l=c.top-r,p=d.offset().top;c=c.top-r-5;(n>p-l||e.dropup)&&-c<p&&k.css("top",c);c=d.offset().left;d=d.width();d=c+d;r=k.offset().left;n=k.outerWidth();0===n&&0<k.children().length&&(n=f(k.children()[0]).outerWidth());
n=r+n;var x=g.offset().left;p=g.outerWidth();l=x+p;if(k.hasClass(e.rightAlignClassName)||k.hasClass(e.leftAlignClassName)||k.hasClass(e.splitAlignClass)||"dt-container"===e.align){var F=l;g.hasClass("dt-btn-split-wrapper")&&0<g.children("button.dt-btn-split-drop").length&&(x=g.children("button.dt-btn-split-drop").offset().left,p=g.children("button.dt-btn-split-drop").outerWidth(),F=x+p);p=0;if(k.hasClass(e.rightAlignClassName))p=l-n,c>r+p&&(c-=r+p,d-=n+p,p=c>d?p+d:p+c);else if(k.hasClass(e.splitRightAlignClassName))p=
F-n,c>r+p&&(c-=r+p,d-=n+p,p=c>d?p+d:p+c);else if(k.hasClass(e.splitLeftAlignClassName)){if(p=x-r,d<n+p||c>r+p)c-=r+p,d-=n+p,p=c>d?p+d:p+c}else p=c-r,d<n+p&&(c-=r+p,d-=n+p,p=c>d?p+d:p+c)}else g.offset(),p=0,p="button-right"===e.align?l-n:x-r;k.css("left",k.position().left+p)}else t=function(){var C=f(D).height()/2,y=k.height()/2;y>C&&(y=C);k.css("marginTop",-1*y)},t(),f(D).on("resize.dtb-collection",function(){t()});e.background&&w.background(!0,e.backgroundClassName,e.fade,e.backgroundHost||g);f("div.dt-button-background").on("click.dtb-collection",
function(){});e.autoClose&&setTimeout(function(){b.on("buttons-action.b-internal",function(C,y,v,B){B[0]!==g[0]&&m()})},0);f(k).trigger("buttons-popover.dt");b.on("destroy",m);setTimeout(function(){h=!1;f("body").on("click.dtb-collection",function(C){if(!h){var y=f.fn.addBack?"addBack":"andSelf",v=f(C.target).parent()[0];(!f(C.target).parents()[y]().filter(a).length&&!f(v).hasClass("dt-buttons")||f(C.target).hasClass("dt-button-background"))&&m()}}).on("keyup.dtb-collection",function(C){27===C.keyCode&&
m()})},0)}}});w.background=function(a,b,c,d){c===q&&(c=400);d||(d=z.body);a?I(f("<div/>").addClass(b).css("display","none").insertAfter(d),c):J(f("div."+b),c,function(){f(this).removeClass(b).remove()})};w.instanceSelector=function(a,b){if(a===q||null===a)return f.map(b,function(e){return e.inst});var c=[],d=f.map(b,function(e){return e.name}),h=function(e){if(Array.isArray(e))for(var g=0,m=e.length;g<m;g++)h(e[g]);else"string"===typeof e?-1!==e.indexOf(",")?h(e.split(",")):(e=f.inArray(e.trim(),
d),-1!==e&&c.push(b[e].inst)):"number"===typeof e?c.push(b[e].inst):"object"===typeof e&&c.push(e)};h(a);return c};w.buttonSelector=function(a,b){for(var c=[],d=function(m,k,t){for(var r,n,l=0,p=k.length;l<p;l++)if(r=k[l])n=t!==q?t+l:l+"",m.push({node:r.node,name:r.conf.name,idx:n}),r.buttons&&d(m,r.buttons,n+"-")},h=function(m,k){var t,r=[];d(r,k.s.buttons);var n=f.map(r,function(l){return l.node});if(Array.isArray(m)||m instanceof f)for(n=0,t=m.length;n<t;n++)h(m[n],k);else if(null===m||m===q||
"*"===m)for(n=0,t=r.length;n<t;n++)c.push({inst:k,node:r[n].node});else if("number"===typeof m)k.s.buttons[m]&&c.push({inst:k,node:k.s.buttons[m].node});else if("string"===typeof m)if(-1!==m.indexOf(","))for(r=m.split(","),n=0,t=r.length;n<t;n++)h(r[n].trim(),k);else if(m.match(/^\d+(\-\d+)*$/))n=f.map(r,function(l){return l.idx}),c.push({inst:k,node:r[f.inArray(m,n)].node});else if(-1!==m.indexOf(":name"))for(m=m.replace(":name",""),n=0,t=r.length;n<t;n++)r[n].name===m&&c.push({inst:k,node:r[n].node});
else f(n).filter(m).each(function(){c.push({inst:k,node:this})});else"object"===typeof m&&m.nodeName&&(r=f.inArray(m,n),-1!==r&&c.push({inst:k,node:n[r]}))},e=0,g=a.length;e<g;e++)h(b,a[e]);return c};w.stripData=function(a,b){if("string"!==typeof a)return a;a=a.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"");a=a.replace(/<!\-\-.*?\-\->/g,"");if(!b||b.stripHtml)a=a.replace(/<[^>]*>/g,"");if(!b||b.trim)a=a.replace(/^\s+|\s+$/g,"");if(!b||b.stripNewlines)a=a.replace(/\n/g," ");if(!b||
b.decodeEntities)M.innerHTML=a,a=M.value;return a};w.defaults={buttons:["copy","excel","csv","pdf","print"],name:"main",tabIndex:0,dom:{container:{tag:"div",className:"dt-buttons"},collection:{tag:"div",className:""},button:{tag:"button",className:"dt-button",active:"active",disabled:"disabled",spacerClass:""},buttonLiner:{tag:"span",className:""},split:{tag:"div",className:"dt-button-split"},splitWrapper:{tag:"div",className:"dt-btn-split-wrapper"},splitDropdown:{tag:"button",text:"&#x25BC;",className:"dt-btn-split-drop",
...
d)},attr:{"aria-haspopup":!0}},split:{text:function(a){return a.i18n("buttons.split","Split")},className:"buttons-split",closeButton:!1,init:function(a,b,c){return b.attr("aria-expanded",!1)},action:function(a,b,c,d){this.popover(d._collection,d)},attr:{"aria-haspopup":!0}},copy:function(a,b){if(A.copyHtml5)return"copyHtml5"},csv:function(a,b){if(A.csvHtml5&&A.csvHtml5.available(a,b))return"csvHtml5"},excel:function(a,b){if(A.excelHtml5&&A.excelHtml5.available(a,b))return"excelHtml5"},pdf:function(a,
b){if(A.pdfHtml5&&A.pdfHtml5.available(a,b))return"pdfHtml5"},pageLength:function(a){a=a.settings()[0].aLengthMenu;var b=[],c=[];if(Array.isArray(a[0]))b=a[0],c=a[1];else for(var d=0;d<a.length;d++){var h=a[d];f.isPlainObject(h)?(b.push(h.value),c.push(h.label)):(b.push(h),c.push(h))}return{extend:"collection",text:function(e){return e.i18n("buttons.pageLength",{"-1":"Show all rows",_:"Show %d rows"},e.page.len())},className:"buttons-page-length",autoClose:!0,buttons:f.map(b,function(e,g){return{text:c[g],
className:"button-page-length",action:function(m,k){k.page.len(e).draw()},init:function(m,k,t){var r=this;k=function(){r.active(m.page.len()===e)};m.on("length.dt"+t.namespace,k);k()},destroy:function(m,k,t){m.off("length.dt"+t.namespace)}}}),init:function(e,g,m){var k=this;e.on("length.dt"+m.namespace,function(){k.text(m.text)})},destroy:function(e,g,m){e.off("length.dt"+m.namespace)}}},spacer:{style:"empty",spacer:!0,text:function(a){return a.i18n("buttons.spacer","")}}});u.Api.register("buttons()",
...
stripNewlines:!0,decodeEntities:!0,trim:!0,format:{header:function(p){return w.stripData(p,c)},footer:function(p){return w.stripData(p,c)},body:function(p){return w.stripData(p,c)}},customizeData:null},b);b=a.columns(c.columns).indexes().map(function(p){var x=a.column(p).header();return c.format.header(x.innerHTML,p,x)}).toArray();var d=a.table().footer()?a.columns(c.columns).indexes().map(function(p){var x=a.column(p).footer();return c.format.footer(x?x.innerHTML:"",p,x)}).toArray():null,h=f.extend({},
c.modifier);a.select&&"function"===typeof a.select.info&&h.selected===q&&a.rows(c.rows,f.extend({selected:!0},h)).any()&&f.extend(h,{selected:!0});h=a.rows(c.rows,h).indexes().toArray();var e=a.cells(h,c.columns);h=e.render(c.orthogonal).toArray();e=e.nodes().toArray();for(var g=b.length,m=[],k=0,t=0,r=0<g?h.length/g:0;t<r;t++){for(var n=[g],l=0;l<g;l++)n[l]=c.format.body(h[k],t,l,e[k]),k++;m[t]=n}b={header:b,footer:d,body:m};c.customizeData&&c.customizeData(b);return b};f.fn.dataTable.Buttons=w;
f.fn.DataTable.Buttons=w;f(z).on("init.dt plugin-init.dt",function(a,b){"dt"===a.namespace&&(a=b.oInit.buttons||u.defaults.buttons)&&!b._buttons&&(new w(b,a)).container()});u.ext.feature.push({fnInit:L,cFeature:"B"});u.ext.features&&u.ext.features.register("buttons",L);return w});

/*!
 * Column visibility buttons 4.0.0-beta for Buttons and DataTables.
...
dtButtons.colvis = function (dt, conf) {
    var node = null;
    var buttonConf = {
        extend: 'collection',
        init: function (dt, n) {
...
dtButtons.columnsToggle = function (dt, conf) {
    var columns = dt
        .columns(conf.columns)
        .indexes()
        .map(function (idx) {
...
dtButtons.columnToggle = function (dt, conf) {
    return {
...
dtButtons.columnsVisibility = function (dt, conf) {
    var columns = dt
        .columns(conf.columns)
        .indexes()
        .map(function (idx) {

...
var m=i(f).closest(".dt-button-info"),g=function(){m.off("click.buttons-copy");i(k).off(".buttons-copy");c.buttons.info(!1)};m.on("click.buttons-copy",g);i(k).on("keydown.buttons-copy",function(a){27===a.keyCode&&g()}).on("copy.buttons-copy cut.buttons-copy",function(){g()})},exportOptions:{},fieldSeparator:"\t",fieldBoundary:"",header:!0,footer:!1};l.ext.buttons.csvHtml5={bom:!1,className:"buttons-csv buttons-html5",available:function(){return g.FileReader!==n&&g.Blob},text:function(a){return a.i18n("buttons.csv",
"CSV")},action:function(a,c,d,b){a=F(c,b).str;c=b.charset;b.customize&&(a=b.customize(a,b));!1!==c?(c||(c=k.characterSet||k.charset),c&&(c=";charset="+c)):c="";b.bom&&(a="﻿"+a);p(new Blob([a],{type:"text/csv"+c}),u(b),!0)},filename:"*",extension:".csv",exportOptions:{},fieldSeparator:",",fieldBoundary:'"',escapeChar:'"',charset:null,header:!0,footer:!1};l.ext.buttons.excelHtml5={className:"buttons-excel buttons-html5",available:function(){return g.FileReader!==n&&(q||g.JSZip)!==n&&!G()&&v},text:function(a){return a.i18n("buttons.excel",
"Excel")},action:function(a,c,d,b){var e=0,a=function(a){return i.parseXML(z[a])},f=a("xl/worksheets/sheet1.xml"),h=f.getElementsByTagName("sheetData")[0],a={_rels:{".rels":a("_rels/.rels")},xl:{_rels:{"workbook.xml.rels":a("xl/_rels/workbook.xml.rels")},"workbook.xml":a("xl/workbook.xml"),"styles.xml":a("xl/styles.xml"),worksheets:{"sheet1.xml":f}},"[Content_Types].xml":a("[Content_Types].xml")},c=c.buttons.exportData(b.exportOptions),m,k,d=function(a){m=e+1;k=o(f,"row",{attr:{r:m}});for(var b=0,
c=a.length;b<c;b++){for(var d=b,g="";0<=d;)g=String.fromCharCode(d%26+65)+g,d=Math.floor(d/26)-1;var d=g+""+m,j=null;if(!(null===a[b]||a[b]===n||""===a[b])){a[b]=i.trim(a[b]);for(var l=0,p=H.length;l<p;l++)if(g=H[l],a[b].match&&!a[b].match(/^0\d+/)&&a[b].match(g.match)){j=a[b].replace(/[^\d\.\-]/g,"");g.fmt&&(j=g.fmt(j));j=o(f,"c",{attr:{r:d,s:g.style},children:[o(f,"v",{text:j})]});break}j||("number"===typeof a[b]||a[b].match&&a[b].match(/^-?\d+(\.\d+)?$/)&&!a[b].match(/^0\d+/)?j=o(f,"c",{attr:{t:"n",
r:d},children:[o(f,"v",{text:a[b]})]}):(g=!a[b].replace?a[b]:a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g,""),j=o(f,"c",{attr:{t:"inlineStr",r:d},children:{row:o(f,"is",{children:{row:o(f,"t",{text:g})}})}})));k.appendChild(j)}}h.appendChild(k);e++};i("sheets sheet",a.xl["workbook.xml"]).attr("name",M(b));b.customizeData&&b.customizeData(c);b.header&&(d(c.header,e),i("row c",f).attr("s","2"));for(var j=0,l=c.body.length;j<l;j++)d(c.body[j],e);b.footer&&c.footer&&(d(c.footer,e),i("row:last c",
f).attr("s","2"));d=o(f,"cols");i("worksheet",f).prepend(d);j=0;for(l=c.header.length;j<l;j++)d.appendChild(o(f,"col",{attr:{min:j+1,max:j+1,width:I(c,j),customWidth:1}}));b.customize&&b.customize(a);c=new (q||g.JSZip);d={type:"blob",mimeType:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"};y(c,a);c.generateAsync?c.generateAsync(d).then(function(a){p(a,u(b))}):p(c.generate(d),u(b))},filename:"*",extension:".xlsx",exportOptions:{},header:!0,footer:!1};l.ext.buttons.pdfHtml5={className:"buttons-pdf buttons-html5",
available:function(){return g.FileReader!==n&&(r||g.pdfMake)},text:function(a){return a.i18n("buttons.pdf","PDF")},action:function(a,c,d,b){E(b);var a=c.buttons.exportData(b.exportOptions),e=[];b.header&&e.push(i.map(a.header,function(a){return{text:"string"===typeof a?a:a+"",style:"tableHeader"}}));for(var f=0,h=a.body.length;f<h;f++)e.push(i.map(a.body[f],function(a){return{text:"string"===typeof a?a:a+"",style:f%2?"tableBodyEven":"tableBodyOdd"}}));b.footer&&a.footer&&e.push(i.map(a.footer,function(a){return{text:"string"===

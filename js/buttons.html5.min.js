...
g++};j("sheets sheet",a.xl["workbook.xml"]).attr("name",N(b));b.customizeData&&b.customizeData(d);var m=function(a,b){var c=j("mergeCells",f);c[0].appendChild(p(f,"mergeCell",{attr:{ref:"A"+a+":"+x(b)+a}}));c.attr("count",c.attr("count")+1);j("row:eq("+(a-1)+") c",f).attr("s","51")},o=c.buttons.exportInfo(b);o.title&&(i([o.title],g),m(g,d.header.length-1));o.messageTop&&(i([o.messageTop],g),m(g,d.header.length-1));b.header&&(i(d.header,g),j("row:last c",f).attr("s","2"));for(var c=0,s=d.body.length;c<
s;c++)i(d.body[c],g);b.footer&&d.footer&&(i(d.footer,g),j("row:last c",f).attr("s","2"));o.messageBottom&&(i([o.messageBottom],g),m(g,d.header.length-1));c=p(f,"cols");j("worksheet",f).prepend(c);i=0;for(m=d.header.length;i<m;i++)c.appendChild(p(f,"col",{attr:{min:i+1,max:i+1,width:J(d,i),customWidth:1}}));b.customize&&b.customize(a);0===j("mergeCells",f).children().length&&j("mergeCells",f).remove();b=new (t||k.JSZip);d={type:"blob",mimeType:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"};

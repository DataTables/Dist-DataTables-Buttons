...
(a=a());return-1!==a.indexOf("*")?a.replace("*",i("title").text()||"Exported data"):a},E=function(a){return a.newline?a.newline:navigator.userAgent.match(/Windows/)?"\r\n":"\n"},F=function(a,c){for(var d=E(c),b=a.buttons.exportData(c.exportOptions),e=c.fieldBoundary,f=c.fieldSeparator,i=RegExp(e,"g"),m=c.escapeChar!==n?c.escapeChar:"\\",h=function(a){for(var b="",c=0,d=a.length;c<d;c++)0<c&&(b+=f),b+=e?e+(""+a[c]).replace(i,m+e)+e:a[c];return b},g=c.header?h(b.header)+d:"",k=c.footer&&b.footer?d+
